...
int main(int argc, char** argv)
{
    ...
    Mat K = (Mat_<double> (3,3) << 520.9, 0.0, 325.1, 0.0, 521.0, 249.7, 0, 0, 1.0);
...
)
{
    ...
    int index = 1;      // why index is set to 1
    ...
    for (const Point2f p:points_2d)
    {
        ...
        edge->setVertex(1,pose);   // 向边添加1类型节点，参考帧的位姿
